...
After this point, we moved into Python. We used the biopython package to align sequences, create an unrooted phylogenetic tree which we output as a .nwk file (tree.nwk). This file was then imported into MEGA X v 11.0.11 so it can be converted and exported as a PNG file called treefinal.png.
